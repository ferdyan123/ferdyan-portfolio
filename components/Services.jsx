    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-12">
          ...
          <span className="font-mono text-muted text-sm tracking-widest uppercase">Services</span>
        </div>
        ...
        <div ref={headingRef} style={{ opacity: 0 }} className="mb-16">
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">
            Apa yang Bisa{' '}
            <span className="text-accent">Gue Bantu</span>
          </h2>
          <p className="text-muted text-base md:text-lg max-w-xl leading-relaxed">
            Dari landing page sampai sistem kompleks — gue handle full stack,
        ...
        <div className="mt-12 flex items-center gap-4">
          ...
          <span className="text-muted text-xs font-mono">// gratis, tanpa komitmen</span>
        </div>
      </div>
    </section>
  )
