        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          {/* WhatsApp CTA */}
            ...
            className="
              ...
              bg-[#7F77DD] hover:bg-[#6d66cc]
              text-white font-semibold text-sm rounded-xl
              transition-all duration-300
              hover:shadow-[0_0_32px_rgba(127,119,221,0.4)]
          ...
          {/* Discovery Form */}
            ...
            href={siteConfig.discoveryForm}
            className="
              inline-flex items-center gap-2 px-7 py-3.5
              border border-white/10 hover:border-[#7F77DD]/50
              text-white/70 hover:text-white font-semibold text-sm rounded-xl
              transition-all duration-300
              hover:-translate-y-0.5
            "
          >
