...
export default function CTA() {
  ...
  const btnPrimary = "inline-flex items-center gap-3 px-7 py-3.5 bg-[#7F77DD] hover:bg-[#6d66cc] text-white font-semibold text-sm rounded-xl transition-all duration-300 hover:shadow-[0_0_32px_rgba(127,119,221,0.4)] hover:-translate-y-0.5";
  const btnSecondary = "inline-flex items-center gap-2 px-7 py-3.5 border border-white/10 hover:border-[#7F77DD]/50 text-white/70 hover:text-white font-semibold text-sm rounded-xl transition-all duration-300 hover:-translate-y-0.5";
    ...
    <section id="contact" ref={sectionRef} className="relative py-24 md:py-32 px-6 md:px-10 max-w-7xl mx-auto">
      ...
      <div ref={contentRef} className="relative rounded-3xl border border-white/8 bg-[#111111] overflow-hidden px-8 py-16 md:px-16 md:py-20 text-center">
        ...
        <h2 className="text-4xl md:text-6xl font-black text-white leading-tight tracking-tight mb-4">
          Got a Project
          <br />
          <span className="text-[#7F77DD]">in Mind?</span>
        </h2>

        <p className="text-base text-white/45 max-w-md mx-auto mb-10 leading-relaxed">
          Dari landing page sampai web app kompleks — aku siap bantu wujudkan ide kamu jadi produk nyata.
        </p>
