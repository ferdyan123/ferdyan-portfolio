...
function SkillCard({ skill }) {
  const floatKeyframe = `
    @keyframes float-${skill.name.replace(/[^a-zA-Z]/g, '')} {
  ...
  return (
    <>
      <style>{floatKeyframe}</style>
      <div
        className="group flex flex-col items-center gap-2 p-4 rounded-2xl border border-border cursor-default"
        style={{
          background: '#111111',
          animation: `float-${skill.name.replace(/[^a-zA-Z]/g, '')} ${4 + (skill.delay % 2)}s ease-in-out ${skill.delay}s infinite`,
        ...
        onMouseEnter={e => {
          ...
          e.currentTarget.style.borderColor = skill.color + '90'
          e.currentTarget.style.boxShadow = `0 16px 40px ${skill.color}25`
        }}
        onMouseLeave={e => {
          e.currentTarget.style.animation = `float-${skill.name.replace(/[^a-zA-Z]/g, '')} ${4 + (skill.delay % 2)}s ease-in-out ${skill.delay}s infinite`
...
export default function Skills() {
  ...
  return (
    <section id="skills" className="py-24 px-6 relative overflow-hidden">
      ...
      <div className="absolute pointer-events-none" style={{ top: '20%', left: '10%', width: '300px', height: '300px', borderRadius: '50%', background: '#8b5cf6', filter: 'blur(120px)', opacity: 0.12 }} />
      <div className="absolute pointer-events-none" style={{ top: '50%', right: '5%', width: '350px', height: '350px', borderRadius: '50%', background: '#3b82f6', filter: 'blur(140px)', opacity: 0.1 }} />
      <div className="absolute pointer-events-none" style={{ bottom: '10%', left: '40%', width: '250px', height: '250px', borderRadius: '50%', background: '#06b6d4', filter: 'blur(100px)', opacity: 0.12 }} />
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        {/* Grid — max 6 per row desktop, 4 tablet, 3 mobile */}
        <div
