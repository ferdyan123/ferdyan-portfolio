...
const TYPE_LABEL = {
  ...
  "Design":       { color: "text-orange-400", dot: "bg-orange-400" },
};
...
function ProjectCard({ project, index }) {
  ...
  return (
    <Link href={`/projects/${project.slug}`} className="block group">
      <article className="relative rounded-2xl border border-white/8 bg-[#111111] overflow-hidden transition-all duration-500 hover:border-[#7F77DD]/40 hover:bg-[#131318] hover:-translate-y-1 hover:shadow-[0_0_40px_rgba(127,119,221,0.08)] will-change-transform">
      ...
      <div ref={headerRef} className="mb-16">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="flex items-center gap-2 text-sm text-white/40">
            <span className="text-2xl font-black text-white/20 tabular-nums" style={{ fontFamily: "var(--font-mono)" }}>
              {projects.length}
            </span>
            <span>projects</span>
          </div>
