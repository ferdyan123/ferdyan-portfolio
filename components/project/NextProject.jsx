  ...
  return (
    <section ref={sectionRef} className="relative py-16 px-6 md:px-10 max-w-7xl mx-auto">
      ...
      <div
        ...
        className="relative rounded-2xl border border-white/8 bg-[#111111] overflow-hidden px-8 py-12 md:px-14 hover:border-[#7F77DD]/40 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_0_40px_rgba(127,119,221,0.08)] cursor-pointer group"
      >
