    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-12">
          ...
          <span className="font-mono text-muted text-sm tracking-widest uppercase">Process</span>
        </div>
        ...
        <div ref={headingRef} style={{ opacity: 0 }} className="mb-16">
          ...
          <p className="text-muted text-base md:text-lg max-w-xl leading-relaxed">
            Proses yang terstruktur = hasil yang predictable. Dari konsultasi pertama
            sampai support pasca-launch, semua ada jalurnya.
          </p>
        </div>
        ...
        <div className="hidden lg:block">
          ...
          <div className="relative mb-2">
            ...
            <div
              ref={lineRef}
              className="absolute top-5 left-[3.5%] right-[3.5%] h-px bg-accent/40 origin-left"
              style={{ scaleX: 0 }}
            />
          </div>
          ...
          <div className="flex flex-col gap-8">
            {process.map((item, i) => (
              <div
                key={item.step}
                ref={(el) => {
                  if (!stepsRef.current.includes(el)) stepsRef.current.push(el)
                }}
                style={{ opacity: 0 }}
        ...
        <div className="mt-14 flex flex-col sm:flex-row items-start sm:items-center gap-4 p-5 rounded-2xl border border-border/50 bg-surface/50">
          ...
          <p className="text-muted text-xs">
            ...
            <span className="text-white font-mono">1–3 hari</span> setelah deal.
            Timeline total rata-rata{' '}
            <span className="text-white font-mono">7–14 hari</span>.
          </p>
        </div>
      </div>
    </section>
